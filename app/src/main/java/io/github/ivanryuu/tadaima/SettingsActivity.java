...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        SwitchPreference homeNetworkSwitch;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("text_message"));

            EditTextPreference editTextPreference = (EditTextPreference) findPreference("phone_number");
            final EditText ET = editTextPreference.getEditText();
